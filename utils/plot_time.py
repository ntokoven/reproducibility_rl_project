...
def calc_run_time(data):
    time_pos = np.argmax(data['avg_ret']) + 1 # first occurence of max value, + 1 for correctly indexing timestamps
    start = datetime.fromtimestamp(data['timestamps'][0])
